...
function generateOfflineExplanation(subtopic, subject, unitTitle, customPrompt = "") {
  ...
  if (customPrompt && customPrompt.trim()) {
    ...
    if (p.includes("সহজ") || p.includes("simpler") || p.includes("সহজ ভাষায়")) {
      ...
      promptAnswer = `**আপনার অনুরোধের পুঙ্খানুপুঙ্খ বিশ্লেষণ:**\n"${p}" প্রসঙ্গে বলা যায়—বোর্ড পরীক্ষায় এই বিষয়ের তাত্ত্বিক স্পষ্টতা ও প্রায়োগিক উদাহরণ সমন্বয় করে লেখা অত্যন্ত জরুরি। মূল সংজ্ঞা (${subtopic.coreConcept}) এবং ইংরেজি পরিভাষাগুলোর (${kwList}) সঠিক সমন্বয় ঘটালে পরীক্ষক পূর্ণ নম্বর প্রদান করেন।`;
    }

    promptSection = `\n\n### 💬 ৭. আপনার অনুরোধ অনুযায়ী বিশেষ বিশ্লেষণ\n\n**আপনার প্রশ্ন/অনুরোধ:** "${p}"\n\n${promptAnswer}`;
  }
